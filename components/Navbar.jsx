...
export default function Navbar(params) {
   return <div className="w-full h-16 fixed bottom-0 flex flex-row justify-between bg-white">
      <div className="w-16 h-16 flex items-center justify-center">
         <Image src="/icons/black/wallet.svg" alt="Wallet" width={32} height={32} />
      </div>

      <div className="w-16 h-16 flex items-center justify-center">
         <Image src="/icons/black/x.svg" alt="Home" width={32} height={32} />
      </div>
      ...
      <div className="w-16 h-16 flex items-center justify-center">
         <Image src="/icons/black/settings.svg" alt="Home" width={32} height={32} />
      </div>
   </div>;
}
